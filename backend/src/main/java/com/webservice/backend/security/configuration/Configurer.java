package com.webservice.backend.security.configuration;

import com.webservice.backend.security.autentication.Filter;
...
public class Configurer extends WebSecurityConfigurerAdapter {
    @Autowired
    private UserSecurityInformation userDetailsService;
